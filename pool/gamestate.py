...
class GameState:
    ...
    def create_white_ball(self):
        ...
        self.ball_pos=[random.randint(80,920),random.randint(80,420)]
        #print("ball_pos : {}".format(self.ball_pos))
        self.white_ball.move_to(self.ball_pos)
